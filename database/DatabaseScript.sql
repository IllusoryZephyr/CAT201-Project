...
CREATE TABLE MESSAGE_TB (
    OWNER_ID NUMBER REFERENCES USER_TB(USER_ID) ON DELETE CASCADE,
    SENDER_ID NUMBER REFERENCES USER_TB(USER_ID) ON DELETE CASCADE,
    TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    MESSAGE VARCHAR2(1000) NOT NULL,
    OWNER_SEEN NUMBER(1) DEFAULT 0 CHECK (OWNER_SEEN = 0 OR OWNER_SEEN = 1),
    ADMIN_SEEN NUMBER(1) DEFAULT 0 CHECK (ADMIN_SEEN = 0 OR ADMIN_SEEN = 1)
);
